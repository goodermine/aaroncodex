...
> **Status update (same day):** the full fix series landed, each item verified
> headless — **all 8 blockers fixed** (B1–B8), plus **M1, M2, M6, M9, M15,
> M17 partially (semantic island + hover + gauges), M16** and several adjacent
> minors. Remaining before beta: the unaddressed majors (concurrency trio M10,
> job caps M8/M11, unified instantiation M12, packaging M13/M14, recorder
> teardown M18) and the minor list — none release-blocking on their own.
