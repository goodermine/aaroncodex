...
def normalise_backend_metrics(raw_metrics: dict) -> dict:
    return {
        ...
        "registers": raw_metrics.get("registers"),
        ...
        "prescriptions": raw_metrics.get("prescriptions"),
    ...
    manifest = {
        ...
        "scoring_policy": {
            ...
            "rules": [
                ...
                "Drill selection: prescribe the prescription engine's primary category (normalised_metrics.prescriptions.primary). You may choose among that category's listed exercises using the singer's drill history, or deviate — but a deviation must be justified explicitly in prose. If no limiter triggered, do not invent one: exercises are prescriptions, not rewards.",
            ],
        },
        "reference": reference,
